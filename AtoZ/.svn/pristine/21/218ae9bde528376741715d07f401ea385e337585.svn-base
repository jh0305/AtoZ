<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
		    ...
		    <div class="container-xl" style="width:1000px; height:400px;">
		    	<!-- 콘텐츠 헤더 -->
						...
						<div class="card-header">
							<div class="col-12" style="height:25px;line-height: 200%;">
								<div class="row">
									...
									<input type="button" onclick="setMngr();" class="btn btn-light" style="width:50px;height:25px;line-height: 85%;" value="적용">
								</div>
							</div>
						</div>
						<div class="card-body">
