...
<div class="col-12">
	...
	<ul class="nav nav-tabs">
		<li class="nav-item"><a href="#tab-top-co" onclick="moveMap('com')" class="nav-link active" data-bs-toggle="tab">기업</a></li>
		<li class="nav-item"><a href="#tab-top-wh" onclick="moveMap('ware')" class="nav-link" data-bs-toggle="tab">물류센터</a></li>
	</ul>
		<div class="tab-content">
			<!-- Content of card #1 -->
			<div id="tab-top-co" class="card tab-pane show active">
				<div class="card-body">
					<div class="row">
			...
			<!-- Content of card #2 -->
			<div id="tab-top-wh" class="card tab-pane">
				<div class="card-body">
					<div class="row">
						<div class="col-4"><strong>회원 아이디</strong></div>
