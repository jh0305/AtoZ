...
public class ServiceUseController {
	...
	@RequestMapping("/serviceUse/accessDenied")
	public String accessDenied(HttpServletResponse response) {
		String url = "serviceUse/accessDenied";
	...
	@RequestMapping("/serviceUse/loginExpired")
	...
	public String login(String id, String pwd, HttpSession session) throws SQLException {
		...
		try {
			serviceUseService.login(id, pwd, session);
		} catch (NotFoundIdException | MissingPasswordException e) {
			url = "redirect:/";
	...
	// 이용신청
	@RequestMapping(value="/serviceUse/registForm", method = {RequestMethod.GET, RequestMethod.POST})
	...
	@RequestMapping(value="/SY/serviceUse/reject", method=RequestMethod.POST)
	@ResponseBody
	public void reject(ApproveClient approveClient, HttpServletResponse response, HttpServletRequest request) throws SQLException, IOException {
		serviceUseService.rejectClient(approveClient);
		response.setContentType("text/html; charset=utf-8");
		PrintWriter out = response.getWriter();
		out.println("<script>");
		out.println("alert('정상적으로 승인되었습니다.');");
...
//---------------------------------영섭------------------------------------------------------------
	...
	public void findPwd(String id, String cl_regno, String cl_email, HttpServletResponse response, HttpServletRequest request) throws Exception{
	...
	public void confirmCode(String cn,HttpSession session, HttpServletResponse response,String id) throws Exception {
		PrintWriter out = response.getWriter();
		response.setContentType("text/plain;charset=utf-8");
	...
	public void changePwd(String id, String pwd, HttpServletResponse response, HttpServletRequest request) throws Exception {
