	    	...
	    	<!-- 콘텐츠 헤더 -->
					...
					<div class="card-body">
						<div class="table-responsive" style="height:380px;">
							<table class="table card-table table-vcenter text-nowrap datatable">
								<thead>
									<tr>
										<th class="text-center"><input type="checkbox" onclick="checkAll('modifyTypeCheck',this);" id="modifyTypeAllCheck"></th>
										<th class="text-center">유형 코드</th>
										<th class="text-center">유 형 명</th>
										<th class="text-center">사용여부</th>
									</tr>
								</thead>
								<tbody id="typeModifyDiv">
				...
				<div class="row" style="margin-top : 10px;">
					<div class="col-10" style="text-align: right;margin-left : auto;">
						<input type="button" class="btn btn-white" onclick="modifyType();" value="저장">
