...
<div class="col-12 card-body" style="padding: 0px 8px;">
	...
	<div class="row">
		<div class="col-12 table-responsive" style="padding: 5px; margin: 0px;">
			<table class="w-1000-table-col-5 table card-table table-vcenter text-nowrap datatable" border=1>
				...
				$.ajax({
					...
					success : function(res) {
						...
						$.each(res, function(i) {
							...
							mycode += '	<td class="item_no">' + res[i].item_no + '</td>';
							var tooltip_code;
							...
							mycode += '	<td class="item_name"'+tooltip_code+'>' + res[i].item_name + '</td>';
							mycode += '	<td class="cp_code">' + res[i].cp_code + '</td>';
							mycode += '	<td class="cp_name">' + res[i].cp_name + '</td>';
							mycode += '	<td class="std_name">' + res[i].std_name + '</td>';
							mycode += '</tr>';
						});
