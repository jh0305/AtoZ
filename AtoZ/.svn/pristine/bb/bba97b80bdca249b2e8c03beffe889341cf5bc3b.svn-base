	    ...
	    <div class="container-xl" style="width:500px; height:200px;">
	    	<!-- 콘텐츠 헤더 -->
					...
					<div class="card-body">
						<table class="table card-table table-vcenter">
							<tr>
								...
								<td><input type="text" class="form-control" placeholder="ex) 10"></td>
							</tr>
							<tr>
								<td class="text-center">코 드</td>
								<td><input type="text" class="form-control" placeholder="ex) 101"></td>
							</tr>
							<tr>
								<td class="text-center">코 드 명</td>
								<td><input type="text" class="form-control" placeholder="ex) 일반"></td>
							</tr>
						</table>
					</div>
					<!-- card-body -->
				...
				<div class="row" style="margin-top : 10px;">
					...
					<div class="col-2" >
						<input type="button" class="btn btn-white" value="초기화">
					</div>
					<div class="col-2" >
