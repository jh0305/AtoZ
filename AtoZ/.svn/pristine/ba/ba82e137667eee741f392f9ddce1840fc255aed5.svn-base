...
<form name="form" method="post">
 <table>
  <tr>
   <td height="10%"><span><a href="<%=request.getContextPath()%>/homepage/home">
          <img src="<%=request.getContextPath() %>/resources/images/AZ.png" height="70" alt=""></a></span> 
    <br>
   </td>
  </tr>
  <tr>
   <td style="padding:1%;">
   	<span style="font-weight: inherit; font-size:28px;">회원가입</span>
   	<hr>
   	</td>
  </tr>
  <tr>
...
셋째, AtoZ 아이디를 이용한 부가 서비스 및 맞춤식 서비스 이용 또는 이벤트 응모 과정에서 해당 서비스의 이용자에 한해서만 개인정보 추가 수집이 발생할 수 있으며, 이러한 경우 별도의 동의를 받습니다.
...
- 생성정보 수집 툴을 통한 수집
   ...
   <input type="checkbox" name="agree" value="true" style="padding:3%;"> 개인정보 수집 및 이용에 동의합니다.
   </div>
   </td>
  </tr>
  <tr>
   <td align="center" valign="top" style="padding:3%;">
    <input type="button" value="기업 이용신청" onclick="COchk()" class="btn btn-info"/>&nbsp;&nbsp;&nbsp;
    <input type="button" value="물류센터 이용신청" onclick="WHchk()" class="btn btn-info"/>&nbsp;&nbsp;&nbsp;
    <input type="submit" value="기업 + 물류센터 이용신청" onclick="COWHchk()" class="btn btn-info"/>&nbsp;&nbsp;&nbsp;
