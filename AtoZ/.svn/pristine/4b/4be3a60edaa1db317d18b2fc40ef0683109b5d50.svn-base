...
<script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
                	<div class="container">
	                  ...
	                  <div class="card-body">
	                <!-- 기업 -->
	              	<form action="<%=request.getContextPath() %>/serviceUse/WHregist" method="post" role="form" enctype="multipart/form-data" id="WHForm">
	              		<input type="hidden" value="ROLE_WH" name="cl_type">
	                    <div class="mb-3">
	                   ...
	                   <div class="mb-3">
	                    ...
	                    <div class="mb-3">
	                    <label class="form-label">물류센터주소</label>
	                        <input type="text" class="form-control" id="sample4_postcode" name="wh_addr" placeholder="우편번호" style="width:300px; display:inline-block" readonly>
							<input type="button" class="btn btn-primary ms-auto" onclick="sample4_execDaumPostcode()" value="우편번호 찾기" style="margin-bottom:1px">
							<input type="text"  class="form-control"id="sample4_roadAddress" name="wh_addr" placeholder="도로명주소" style="margin-top:3px" readonly>
							<span id="guide" style="color:#999;display:none"></span>
							<input type="text"  class="form-control"id="sample4_detailAddress" name="wh_addr" placeholder="상세주소" style="margin-top:3px">
	                    </div>
	                    <div class="mb-3">
