...
public class PaymentController {
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> getPaymentRequestForm(SearchMap searchMap, @RequestParam(defaultValue="") String keyword, HttpSession session)
			throws Exception {
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> getPaymentResultForm(SearchMap searchMap, @RequestParam(defaultValue="") String keyword, HttpSession session)
			throws Exception {
		ResponseEntity<Map<String, Object>> entity = null;
