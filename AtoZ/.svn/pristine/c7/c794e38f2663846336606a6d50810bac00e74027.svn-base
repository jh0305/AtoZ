...
public class OrderVO {
	...
	private String req_ymd_after;
	private String deli_ymd_after;
	private int ord_no;
	...
	private String in_chrg;
	private String upd_name;
	private String upd_ymd;
	List<OrderItemVO> orderItemList;
	List<OrderDetailCommand> orderDetailCommand;
	...
	public String getReq_ymd_after() {
		return req_ymd_after;
	}

	public void setReq_ymd_after(String req_ymd_after) {
		this.req_ymd_after = req_ymd_after;
	}

	public String getDeli_ymd_after() {
		return deli_ymd_after;
	}

	public void setDeli_ymd_after(String deli_ymd_after) {
		this.deli_ymd_after = deli_ymd_after;
	}
	...
	public String getIn_chrg() {
		return in_chrg;
	}

	public void setIn_chrg(String in_chrg) {
	...
	public List<OrderDetailCommand> getOrderDetailCommand() {
		return orderDetailCommand;
	}

	public void setOrderDetailCommand(List<OrderDetailCommand> orderDetailCommand) {
		this.orderDetailCommand = orderDetailCommand;
	}

	@Override
	public String toString() {
		return "OrderVO [cl_name=" + cl_name + ", req_ymd_after=" + req_ymd_after + ", deli_ymd_after=" + deli_ymd_after
				+ ", ord_no=" + ord_no + ", co_code=" + co_code + ", wh_code=" + wh_code + ", pay_no=" + pay_no
				...
				+ ", upd_name=" + upd_name + ", upd_ymd=" + upd_ymd + ", orderItemList=" + orderItemList
				+ ", orderDetailCommand=" + orderDetailCommand + "]";
	}
