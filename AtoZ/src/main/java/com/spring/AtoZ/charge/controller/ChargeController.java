...
public class ChargeController {
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> chargeMainChargeRequestList(SearchMap sm, @RequestParam(defaultValue="") String keyword, HttpSession session) throws Exception{
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> chargeMainChargeResultList(SearchMap sm,@RequestParam(defaultValue="") String keyword, HttpSession session) throws Exception{
		ResponseEntity<Map<String, Object>> entity = null;
