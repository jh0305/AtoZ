...
public class DetailMemberCommand {
	private String sts_code;	// 고객상태코드
	private String head_code;	// 본사코드
	private String cl_type;		// 고객유형
	private int act_yn;			// 고객활성여부
	private String cre_ymd;		// 가입신청일자
	private String wh_addr;		// 물류창고주소
	...
	public int getDf_area() {
		return df_area;
	}
	public void setDf_area(int df_area) {
		this.df_area = df_area;
	}
}
