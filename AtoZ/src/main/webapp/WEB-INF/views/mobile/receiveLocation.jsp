<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="content">
    	...
    	<div class="row">
    		<div class="btn btn-dark" style="width:80%;height:50px;margin-left:10%;"><h1>입고</h1></div>
    	</div>
	...
	window.onload = function(){
	     ...
	     qrcode.callback = res => { 
	       if (res) {
	    	 ...
	    	 window.location.href = "m.receive?inv_loc="+code;
	    	 ...
	    	 window.location.href = "m.receiveForm?inv_loc="+code;
	       }
	     };
