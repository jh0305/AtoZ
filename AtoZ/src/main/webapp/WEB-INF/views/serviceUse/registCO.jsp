...
<script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
                	<div class="container">
	                  ...
	                  <div class="card-body">
	                <!-- 기업 -->
	              	<form action="<%=request.getContextPath() %>/serviceUse/COregist" method="post" role="form" enctype="multipart/form-data" id="WHForm">
	              		<input type="hidden" value="ROLE_CO" name="cl_type">
	                    <div class="mb-3">
